...
var iventoryRoute = require("../app/routes/inventory.route.js");
...
app.use('/inventory-service/apis/swagger', express.static('./public/swagger-ui'));
...
app.use('/inventory-service/apis', router);
